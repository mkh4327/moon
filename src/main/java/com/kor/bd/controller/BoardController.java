...
import com.kor.bd.service.BoardService;
import com.kor.bd.util.MyUtil;
...
public class BoardController {
	...
	public ModelAndView index2() throws Exception{
		...
		mav.setViewName("index2"); //jsp(html)로 갈때는 setViewName // class로 갈때는 setView
	...
	public ModelAndView created() throws Exception{
		...
		mav.setViewName("bd/created"); //jsp(html)로 갈때는 setViewName // class로 갈때는 setView
