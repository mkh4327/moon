        ...
        <nav class="navbar navbar-expand-lg custom_nav-container">
          ...
          <div id="myNav" class="overlay">
            ...
            <div class="overlay-content">
              <a class="active" href="index.jsp"> Home <span class="sr-only">(current)</span></a>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="box">
            <div class="img-box">
              <img src="../../resources/images/service4.png" alt="" />
            </div>
            <div class="detail-box">
              <h4>
                Baby Walk
  ...
  <section class="wehave_section">
    <div class="container-fluid">
      <div class="box">
        ...
        <div class="img-box">
          <img src="../../resources/images/we_img.jpg" alt="" />
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="why_section layout_padding">
    <div class="container">
      ...
      <div class="why_container">
        <div class="box">
          <div class="img-box">
            <img src="../../resources/images/why1.png" alt="" />
          </div>
          <div class="detail-box">
            <h5>
        ...
        <div class="box">
          <div class="img-box">
            <img src="../../resources/images/why2.png" alt="" />
          </div>
          <div class="detail-box">
            <h5>
        ...
        <div class="box">
          <div class="img-box">
            <img src="../../resources/images/why3.png" alt="" />
          </div>
          <div class="detail-box">
            <h5>
        ...
        <div class="box">
          <div class="img-box">
            <img src="../../resources/images/why4.png" alt="" />
          </div>
          <div class="detail-box">
            <h5>
              Successful
      ...
      <div class="carousel-wrap ">
        <div class="owl-carousel team_carousel">
          ...
          <div class="item">
            <div class="box">
              <div class="img-box">
                <img src="../../resources/images/team5.jpg" alt="" />
              </div>
              <div class="detail-box">
                <h6>
                  Hennry bilisom
        ...
        <div class="col-md-4">
          <div class="info_link_box">
            ...
            <div class="info_links">
              <a class="active" href="index.jsp"> <i class="fa fa-angle-right" aria-hidden="true"></i> Home <span class="sr-only">(current)</span></a>
